...
<head>
<meta charset="utf-8"/>
<title>STMIK BANDUNG TALK | Kegiatan</title>
...
<link href="http://localhost/miniproject/assets/js/sweetalert2.all.min.js" rel="stylesheet" type="text/css"/>
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user dropdown-bright">
						...
						<img alt="" class="img-circle" src="http://localhost/miniproject/assets/administrator.png"/>
						</a>
