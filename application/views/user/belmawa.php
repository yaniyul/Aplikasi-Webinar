		...
		<div class="page-content">
			...
			<div class="col-lg-3 col-md-3">
				...
				<div class="polaroid">
                    ...
                    <center><img src="<?php echo base_url(); ?>assets/lampiran/<?php echo $bel['lampiran'];?>" alt="Lampiran" style="width:90% ">
                    <br><div>
                        <td style="width:5%">
                            <center><h4><b><?php echo $bel['nama_belmawa'] ?> </b></h4></center>
						</td>
                    </div>
					<br>
                    <center>
						<a href="<?php echo base_url('detail_bel/'.$bel['id_belmawa']);?>" class="btn btn-sm blue" data-toggle="modal" >Lihat</a>
			...
			<script>
				document.getElementById("daftarButton").addEventListener("click", function(){
					var daftar_bel = "sukses";
					if (daftar_bel==="sukses"){
